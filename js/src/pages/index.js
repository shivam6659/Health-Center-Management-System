...
import HospitalIcons from "../assets/icon/hospitalicons.png";
...
function HomePage() {
  ...
  return (
    <div>
      ...
      <Header />
         <center> <label className={styles.lblBuyingSelling}>
                India's Best Health Center Management System Doctors
           </label></center>
      <div className={styles.container}>
      <Image src={HospitalIcons}  alt='Script Content' />  
        <main className={styles.cardCon}>
          ...
          <div className={styles.inpBtnCon}>
            <input className={styles.inp} value={scripValue} maxLength={15} id="enterScriptValue" placeholder=' Health Center' onChange={(val) => {
      ...
      <div className={styles.ul_top_hypers}>
        ...
        <div className={styles.bottomCon}>
          ...
          <br />
          <label className={styles.bottomLblDesc}>
           1.Dr. Hemant Kumar(MBBS,Md)
           2.Dr. Deepak Kumar(MBBS,Md)
           3.Dr. Himani Gupta(MBBS,Md)
          </label>
